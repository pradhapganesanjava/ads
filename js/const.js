...
export const RANGE = 'fb_all_prob'; // Adjust the range as per your Google Sheet
...
export const REDIRECT_URI = `https://pradhapganesanjava.github.io/pg-ads/pg_ads.html`;  
